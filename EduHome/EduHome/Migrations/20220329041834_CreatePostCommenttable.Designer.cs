...
namespace EduHome.Migrations
{
    ...
    [Migration("20220329041834_CreatePostCommenttable")]
    partial class CreatePostCommenttable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduHome.Models.CommentEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("CommentEntity");
                });
            ...
            modelBuilder.Entity("EduHome.Models.EventSpeakers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EduHome.Models.BlogComment", b =>
                {
                    b.HasBaseType("EduHome.Models.CommentEntity");
            ...
            modelBuilder.Entity("EduHome.Models.SocialLink", b =>
                {
                    b.HasOne("EduHome.Models.Teacher", "Teacher")
                        .WithOne("Social")
                        .HasForeignKey("EduHome.Models.SocialLink", "TeacherId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("EduHome.Models.BlogComment", b =>
                {
                    b.HasOne("EduHome.Models.Post", "Post")
